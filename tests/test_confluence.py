...
def test_search(fetcher, mock_confluence):
    ...
    assert documents[0].metadata["url"] == "https://example.atlassian.net/wiki/spaces/TEAM/pages/123456789/2024-01-01+Team+Progress+Meeting+01"
    assert documents[0].page_content == "📅 Date\n2024-01-01\n👥 Participants\nJohn Smith\nJane Doe\nBob Wilson\n!-@123456"
